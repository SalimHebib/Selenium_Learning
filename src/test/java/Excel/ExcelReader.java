...
public class ExcelReader {
    ...
    public static void main(String[] args)  {
        String path = "C:\\Users\\hebib\\PNT\\SeleniumLearning\\Product.xlsx";
        ExcelReader excelReader = new ExcelReader(path);
        List<String> item1 = excelReader.getEntireColumnForGivenHeader("Product data", "NAME");
        String item2 = excelReader.getValueForGivenHeaderAndKey("Product data", "ID", "id03");
